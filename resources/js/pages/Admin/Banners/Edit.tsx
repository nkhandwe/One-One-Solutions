                ...
                <div className="mx-auto max-w-7xl space-y-6">
                    ...
                    <div className="flex items-center gap-4">
                        ...
                        <div className="flex-1">
                            ...
                            <p style={{ color: colors.text.tertiary }}>Update your banner information and settings</p>
                        </div>
                    ...
                    <form id="banner-edit-form" onSubmit={handleSubmit} className="space-y-6">
                        {/* Main Content */}
                        <div className="grid grid-cols-1 gap-6 xl:grid-cols-4">
                            ...
                            <div className="space-y-6 xl:col-span-1">
                                ...
                                >
                                    <CardHeader>
                                        <CardTitle className="flex items-center gap-2" style={{ color: colors.text.primary }}>
                                            <Image className="h-5 w-5" style={{ color: colors.accent.main }} />
                                            Banner Statistics
                                        </CardTitle>
                                    </CardHeader>
