...
export default function BlogEdit({ blog, categories }: Props) {
                            ...
                            <div className="space-y-6 xl:col-span-1">
                                ...
                                >
                                    ...
                                    <CardContent className="space-y-4">
                                        ...
                                        {blog.published_at && (
                                            <p className="text-xs" style={{ color: colors.text.tertiary }}>
                                                Originally published: {new Date(blog.published_at).toLocaleDateString()}
                                            </p>
                                        )}
                                    </CardContent>
                                </Card>
                                ...
                                >
                                    ...
                                    <CardContent className="space-y-3">
                                        <div className="flex justify-between">
                                            <span className="text-sm" style={{ color: colors.text.tertiary }}>Views:</span>
                                            <span className="font-semibold" style={{ color: colors.text.primary }}>{blog.views_count}</span>
                                        </div>
                                        <div className="flex justify-between">
                                            <span className="text-sm" style={{ color: colors.text.tertiary }}>Reading Time:</span>
                                            <span className="font-semibold" style={{ color: colors.text.primary }}>{blog.reading_time} min</span>
                                        </div>
                                        <div className="flex justify-between">
                                            <span className="text-sm" style={{ color: colors.text.tertiary }}>Created:</span>
                                            <span className="text-xs" style={{ color: colors.text.secondary }}>
                                                {new Date(blog.created_at).toLocaleDateString()}
                                            </span>
                                        </div>
                                        <div className="flex justify-between">
                                            <span className="text-sm" style={{ color: colors.text.tertiary }}>Last Updated:</span>
                                            <span className="text-xs" style={{ color: colors.text.secondary }}>
                            ...
                            <CardContent>
                                {formData.title ? (
                                    <div className="space-y-4">
                                        ...
                                        <div className="space-y-2">
                                            {formData.category_id && formData.category_id !== 'none' && categories.find((c) => c.id.toString() === formData.category_id) && (
                                                <div className="flex items-center gap-2">
                                                    <div
                                                        className="h-3 w-3 rounded-full"
                                                        style={{
                                                            backgroundColor: categories.find((c) => c.id.toString() === formData.category_id)?.color,
                                                        }}
                                                    ></div>
