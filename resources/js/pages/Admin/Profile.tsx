                ...
                <div className="mx-auto max-w-4xl space-y-6">
                    ...
                    <div className="flex items-center gap-4">
                        ...
                        <div>
                            ...
                            <p style={{ color: colors.text.tertiary }}>Manage your account information</p>
                        </div>
                    </div>
                        ...
                        >
                            ...
                            <CardContent className="space-y-4">
                                <div className="flex items-center gap-3">
                                    <div
                                        className="flex h-16 w-16 items-center justify-center rounded-full font-semibold text-white shadow-lg"
                                        style={{
